 ...
 * (rename / move / delete / new), drag-to-move, and inline rename. The editor
 * screen's data (documents + folders) drives it; every mutation calls
 * onRefresh() (the desktop analogue of the web app's router.refresh()).
 */

/**
 * Single source of truth for what a `#tag` and a `[[wiki-link]]` are. The editor
 * decorations (Phase 04), the preview renderers, and the deterministic graph
 * builder (Phase 07) all use this so they can never disagree. Pure + no deps.
 */

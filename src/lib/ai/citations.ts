// COPIED VERBATIM from the Lattice web monorepo: packages/ai/src/citations.ts.
// Only the Citation type import was repointed from @lattice/db to @/lib/types
// (identical shape). PARITY-CRITICAL.

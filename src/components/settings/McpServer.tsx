    ...
    <div className="grid gap-6">
      <section className="rounded-lg border border-border bg-surface p-5">
        ...
        <p className="mt-3 text-[11px] text-muted">
          Agents see the workspace that is open right now — <code>{status.workspacePath}</code>.
          Switching workspaces restarts Lattice and the server with it.
        </p>
      </section>
      ...
      <section className="rounded-lg border border-border bg-surface p-5">
        ...
        <p className="mt-2 text-[11px] text-muted">
          Regenerating breaks any client still using the old token — reconnect
